...
def get_core_domains() -> list[DomainModule]:
    ...
    from rhoai_mcp.domains.connections.tools import (
        register_tools as connections_tools,
    )
    from rhoai_mcp.domains.inference.tools import register_tools as inference_tools
    from rhoai_mcp.domains.notebooks.tools import register_tools as notebooks_tools
    from rhoai_mcp.domains.pipelines.tools import register_tools as pipelines_tools
    from rhoai_mcp.domains.projects.resources import (
        register_resources as projects_resources,
    )
    from rhoai_mcp.domains.projects.tools import register_tools as projects_tools
    from rhoai_mcp.domains.storage.tools import register_tools as storage_tools
    from rhoai_mcp.domains.training.tools import register_tools as training_tools
