...
Note: The train() tool has been consolidated into the unified training()
tool (action="create"). This module retains run_container_training_job
and analyze_training_failure which are not duplicated.
"""
