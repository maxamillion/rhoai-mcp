...
Note: list_inference_services, get_inference_service, delete_inference_service,
check_deployment_prerequisites, estimate_serving_resources, and recommend_serving_runtime
have been consolidated into the cluster composite tools (list_resources, get_resource,
manage_resource) and prepare_model_deployment.
"""
